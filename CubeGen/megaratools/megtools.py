...
def megarafiber_pos(hdr,hdr0,verbose=False,astmet=True,dtheta_ipa=0.0,flipy=False,flipx=False,scfy=1.0,scfx=1.0):
    nfib=hdr['NFIBERS']
    psc=hdr['PSCALE']
    ...
    if astmet:
        ...
        try:
            ...
            x_ifu =scfx*xfl*x_rot+(hdr['CRVAL1']*3600.0)
            y_ifu =scfy*yfl*y_rot+(hdr['CRVAL2']*3600.0)
        except:
            if verbose:
