...
def megmap_ifu(reduxL,nameF=None,errors=False,flu16=True,spec_range=(None,None),headerInfo={},
    ...
    facT=[],dx=0,dy=0,dtheta_ipa=0.0,flipy=False,flipx=False):
    """
    ...
    for ii in range(0, nlt):
        ...
        if ii == 0:
            ...
            x_ifu,y_ifu,fib_idt,fib_ids=mtools.megarafiber_pos(hdr1,hdr,verbose=verbose,dtheta_ipa=dtheta_ipa,flipy=flipy,flipx=flipx)
            crval=hdr['CRVAL1']
            cdelt=hdr['CDELT1']
            crpix=hdr['CRPIX1']
